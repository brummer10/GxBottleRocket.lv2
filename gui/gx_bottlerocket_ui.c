...
static void ref_value_changed(GtkAdjustment *adj, gpointer* args) {
    ...
    gx_bottlerocketUI* ui = (gx_bottlerocketUI*)arg->ui;
    if (ui->block) {
        ui->block = 0;
        return;
    }
...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    *widget = NULL;
    ...
    const char* plug_name = "GxBottleRocket" ;
    ...
    set_expose_func(GX_BOTTLEROCKET_PAINT_BOX(ui->pbox),"pedal_expose");
    ...
    set_expose_func(GX_BOTTLEROCKET_PAINT_BOX(ui->pf1box),"frame_expose");
    ...
    ui->adj[3] = gtk_adjustment_new( 0.25, 0.0, 1.0, 0.01, 0.01*10.0, 0);
